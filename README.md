...
- 課題解決のために考えたこと
  - 勉強する上で他者を意識したアウトプットはとても効果的です。アウトプットすることで他者から評価してもらう機会ができ、学習のモチベーションを維持できます。アウトプットの場と人が繋がる場を合わせたアプリケーションを作成することで、学習意欲と学力の向上を期待できるのではないかと考えました。
...
| コンテンツ投稿機能 | 学習した内容や書き留めておきたい問題等をアプリケーション上で保存・管理できるようにするため           | 約25h   |
...
・コンテンツ検索ページには、公開されている全てのコンテンツが時系列順で表示されます。<br>
...
・キーワードを入力すると、条件を絞ってユーザーを検索することができます。<br>
